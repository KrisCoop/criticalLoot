...
const GoodRoll = () => {
    ...
    let [imageSource, updateImageSource] = useState('url(https://st2.depositphotos.com/1724125/6601/v/950/depositphotos_66010155-stock-illustration-treasure-chest.jpg)')
